...
void _aiv_gb_sub_internal(aiv_gameboy *gb, u8_t to_sub)
{
...
{
    _aiv_gb_sub_internal(gb, aiv_gb_memory_read8(gb, gb->hl));
...
{
    _aiv_gb_sub_internal(gb, gb->b + IS_CARRY_SETTED(gb));
...
{
    _aiv_gb_sub_internal(gb, gb->c + IS_CARRY_SETTED(gb));
...
{
    _aiv_gb_sub_internal(gb, gb->d + IS_CARRY_SETTED(gb));
...
{
    _aiv_gb_sub_internal(gb, gb->e + IS_CARRY_SETTED(gb));
...
{
    _aiv_gb_sub_internal(gb, gb->h + IS_CARRY_SETTED(gb));
...
{
    _aiv_gb_sub_internal(gb, gb->l + IS_CARRY_SETTED(gb));
...
{
    _aiv_gb_sub_internal(gb, aiv_gb_memory_read8(gb, gb->hl) + IS_CARRY_SETTED(gb));
...
{
    _aiv_gb_sub_internal(gb, gb->a + IS_CARRY_SETTED(gb));

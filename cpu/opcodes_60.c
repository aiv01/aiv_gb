...
{
    aiv_gb_memory_write8(gb, gb->h, gb->b);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->h, gb->c);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->h, gb->d);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->h, gb->e);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->h, gb->h);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->h, gb->l);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->h, gb->a);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->l, gb->b);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->l, gb->c);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->l, gb->d);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->l, gb->e);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->l, gb->h);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->l, gb->l);
    return 4;
}
...
{
    aiv_gb_memory_write8(gb, gb->l, gb->a);
    return 4;
}
